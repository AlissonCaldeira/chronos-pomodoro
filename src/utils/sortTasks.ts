// Função genérica para ordenar o array de task
//
...
//
// O spread [...task] cria uma cópia do array original para não alterar ele direto.
...
export type SortTasksOptions = {
  task: TaskModel[]; // Lista de tarefas que será ordenada
